...
$config['search_api.server.solr']['backend_config']['connector_config']['http']['http_user'] = getenv('SOLR_HTTP_USER');
$config['search_api.server.solr']['backend_config']['connector_config']['http']['http_pass'] = getenv('SOLR_HTTP_PASS');
$config['search_api.server.solr']['name'] = getenv('SOLR_NAME');

// Motamo site ID.
$config['matomo.settings']['matomo_site_id'] = getenv('MATOMO_SITE_ID');

// Beliana Sync
$config['beliana_sync.config']['remote_url'] = getenv('BELIANA_SYNC_REMOTE_URL');
