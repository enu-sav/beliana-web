...
namespace Drupal\beliana_search\Plugin\facets\processor;
 ...
 *
 * @FacetsProcessor(
 *   id = "beliana_display_value_widget_order",
 *   label = @Translation("Sort by display value (without transliteration)"),
...
class DisplayValueWidgetOrderProcessor extends SortProcessorPluginBase implements SortProcessorInterface, ContainerFactoryPluginInterface {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    return new static(
        $configuration, $plugin_id, $plugin_definition, $container->get('transliteration')
    );
  }
  ...
  public function sortResults(Result $a, Result $b) {
    ...
    return strcoll($a->getDisplayValue(), $b->getDisplayValue());
  }
