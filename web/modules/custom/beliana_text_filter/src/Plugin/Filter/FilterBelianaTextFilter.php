...
/**
 * @Filter(
 *   id = "filter_beliana_text_filter",
 *   title = @Translation("Beliana text filter"),
 *   description = @Translation("Custom filter to style tables"),
 *   type = Drupal\filter\Plugin\FilterInterface::TYPE_MARKUP_LANGUAGE,
 * )
 */
class FilterBelianaTextFilter extends FilterBase {
